...
def load_config(path: str | os.PathLike | None = None) -> dict:
    ...
    cfg = {
        ...
        "ssl_certfile": os.environ.get("FUNASR_SSL_CERTFILE", ""),
        "ssl_keyfile": os.environ.get("FUNASR_SSL_KEYFILE", ""),
        "ssl_keyfile_password": os.environ.get("FUNASR_SSL_KEYFILE_PASSWORD", ""),
